...
class HttpRequest {
  ...
  // 常用请求方法封装
  get<T>(url: string, params?: Recordable, _object = {}): Promise<ResData<T>> {
    return this.service.get(url, { params, ..._object })
  }
  post<T>(url: string, params?: Recordable, _object = {}): Promise<ResData<T>> {
    return this.service.post(url, params, _object)
  }
  put<T>(url: string, params?: Recordable, _object = {}): Promise<ResData<T>> {
    return this.service.put(url, params, _object)
  }
  delete<T>(url: string, params?: Recordable, _object = {}): Promise<ResData<T>> {
